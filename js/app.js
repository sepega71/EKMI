 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".subheader__slider")) new swiper_core_Swiper(".subheader__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".newproducts__slider")) new swiper_core_Swiper(".newproducts__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".publications__slider")) new swiper_core_Swiper(".publications__slider", {
            ...
            if (document.querySelector(".footer-partners__slider")) new swiper_core_Swiper(".footer-partners__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
